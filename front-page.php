...
<?php the_content();?>
    <section class="container-presentation">
        <div class="container-img-presentation">
            <img class="trace-presentation" src="wp-content/themes/entrecieletmer/assets/img/trace_portrait.png">
            <img class="img-presentation" src="wp-content/themes/entrecieletmer/assets/img/portrait.png">
        </div>
        <div class="container-content-presentation">
            <div class="container-txt-presentation">
                ...
                <p>Je suis Adeline, infirmière diplômée en Hypnose thérapeutique et praticienne
                    ...
                    avant tout d’accompagner les femmes pour les aider à s’épanouir à chaque étape de
                    leur vie, de la puberté à la maternité sans oublier la ménopause.

                    La vie d’une femme est faite d’une multitude de changements qui nécessitent remise
                    en questions et adaptations constante.
                    Il est parfois facile de se laisser submerger.
    ...
    <section class="container-cabinet">
